...
/* 20reasons -- supply nu,mber of columns on the active Page to the Smarty engine*/
if($theme == '20reasons'){
	$sugar_smarty->assign('activePageColumns', $pages[$activePage]['numColumns']);
    if ($pages[$activePage]['isReference'] == true)
        $sugar_smarty->assign('lock_homepage', true);
}
/* end 20reasons*/
...
//20reasons modification
if($theme == '20reasons'){
	echo $sugar_smarty->fetch('themes/20reasons/tpls/MySugar.tpl');
}else{
