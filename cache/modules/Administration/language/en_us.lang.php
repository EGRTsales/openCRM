...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_TRTHEMECONFIG_LINK1_TITLE' => '20reasons Theme Settings',
  'LBL_TRTHEMECONFIG_LINK1_DESCRIPTION' => 'general Theme Options',
  'LBL_TRTHEMECONFIG_LINK2_TITLE' => 'Home-Pages Administration (BETA)',
  'LBL_TRTHEMECONFIG_LINK2_DESCRIPTION' => 'publish Home Pages to a set of users (BETA)',
);