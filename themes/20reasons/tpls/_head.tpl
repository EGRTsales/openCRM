...
<html {$langHeader}>
<head>
<link rel="SHORTCUT ICON" href="themes/20reasons/images/favicon.png">
...
{$SUGAR_CSS}
<link rel="stylesheet" href="modules/TRThemeController/TRSideBarWidgets/css/TRSideBarWidgets.css">
{$SUGAR_JS}
<link rel="stylesheet" href="themes/20reasons/css/jquery-ui-1.9.2.custom.css">
{literal}
