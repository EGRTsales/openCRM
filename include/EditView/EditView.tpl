...
<h4>&nbsp;&nbsp;
 ...
 {{/if}}
 {* 20reasons changed cellspacing from 1 to 0 *}
<table width="100%" border="0" cellspacing="0" cellpadding="0" {{if $label == 'DEFAULT'}} id='Default_{$module}_Subpanel' {{else}} id='{{$label}}' {{/if}} class="yui3-skin-sam edit view panelContainer">
